namespace Telerik.SvgIcons
{
    public class PlusCircle : SvgIconBase
    {
        ...
        {
            Name = "plus-circle";
            Content = "<path d=\"M12 1.673A10.327 10.327 0 1 0 22.327 12 10.339 10.339 0 0 0 12 1.673m0 19.44A9.113 9.113 0 1 1 21.113 12 9.12 9.12 0 0 1 12 21.113M16.657 12a.607.607 0 0 1-.607.607h-3.443v3.443a.608.608 0 0 1-1.215 0v-3.443H7.949a.608.608 0 0 1 0-1.215h3.443V7.949a.608.608 0 0 1 1.215 0v3.443h3.443a.607.607 0 0 1 .607.607z\"/>";
            ViewBox = "0 0 24 24";
