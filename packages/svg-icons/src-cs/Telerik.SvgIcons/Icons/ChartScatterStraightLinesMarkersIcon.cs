...
{
    public class ChartScatterStraightLinesMarkersIcon : SvgIconBase
    {
        public ChartScatterStraightLinesMarkersIcon()
        {
            Name = "chart-scatter-straight-lines-markers-icon";
