...
{
    public class Book : SvgIconBase
    {
        public Book()
        {
            Name = "book";
            Content = "<path stroke-linecap=\"round\" stroke-linejoin=\"round\" d=\"M4.5 20.25A2.25 2.25 0 0 1 6.75 18H19.5V3H6.75A2.25 2.25 0 0 0 4.5 5.25zm0 0V21H18\" fill=\"none\" stroke-width=\"var(--kendo-icon-stroke-width, 1.5)\"/>";
            ViewBox = "0 0 24 24";
