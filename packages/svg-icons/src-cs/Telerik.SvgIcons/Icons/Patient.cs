namespace Telerik.SvgIcons
{
    public class Patient : SvgIconBase
    {
        public Patient()
        {
            ...
            {
                { "solid", "<path d=\"M22.422 21.316a.816.816 0 0 1-.702.404H2.28a.81.81 0 0 1-.701-1.214c1.542-2.666 3.918-4.578 6.691-5.484a7.29 7.29 0 1 1 7.458 0c2.773.906 5.149 2.818 6.692 5.484a.816.816 0 0 1 .001.81z\"/>" },
