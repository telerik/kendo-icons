...
{
    public class Grid : SvgIconBase
    {
        public Grid()
        {
            Name = "grid";
            Content = "<path stroke-linecap=\"round\" stroke-linejoin=\"round\" d=\"M12 4.5v15M4.5 12h15M5.25 4.5h13.5a.75.75 0 0 1 .75.75v13.5a.75.75 0 0 1-.75.75H5.25a.75.75 0 0 1-.75-.75V5.25a.75.75 0 0 1 .75-.75\" fill=\"none\" stroke-width=\"var(--kendo-icon-stroke-width, 1.5)\"/>";
            ViewBox = "0 0 24 24";
            Variants = new System.Collections.Generic.Dictionary<string, string>
            {
                ...
                { "outline", "<path stroke-linecap=\"round\" stroke-linejoin=\"round\" d=\"M12 4.5v15M4.5 12h15M5.25 4.5h13.5a.75.75 0 0 1 .75.75v13.5a.75.75 0 0 1-.75.75H5.25a.75.75 0 0 1-.75-.75V5.25a.75.75 0 0 1 .75-.75\" fill=\"none\" stroke-width=\"var(--kendo-icon-stroke-width, 1.5)\"/>" },
