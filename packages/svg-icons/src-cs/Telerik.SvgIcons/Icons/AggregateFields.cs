...
{
    public class AggregateFields : SvgIconBase
    {
        public AggregateFields()
        {
            Name = "aggregate-fields";
            Content = "<path stroke-linecap=\"round\" stroke-linejoin=\"round\" d=\"M5.25 6h13.5m-12-3h10.5M4.5 9h15a.75.75 0 0 1 .75.75v9a.75.75 0 0 1-.75.75h-15a.75.75 0 0 1-.75-.75v-9A.75.75 0 0 1 4.5 9\" fill=\"none\" stroke-width=\"var(--kendo-icon-stroke-width, 1.5)\"/>";
            ViewBox = "0 0 24 24";
