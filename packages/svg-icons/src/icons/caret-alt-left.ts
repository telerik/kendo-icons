...
export const caretAltLeftIcon: SVGIcon = {
    name: 'caret-alt-left',
    content: '<path stroke-linecap="round" stroke-linejoin="round" d="M15 19.5 7.5 12 15 4.5" fill="none" stroke-width="var(--kendo-icon-stroke-width, 1.5)"/>',
    viewBox: '0 0 24 24',
    variants: {
    ...
    tags: ['caret', 'alt', 'left', 'navigation', 'arrow', 'dropdown', 'expand']
}
