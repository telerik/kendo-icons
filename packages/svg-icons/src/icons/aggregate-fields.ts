...
export const aggregateFieldsIcon: SVGIcon = {
    name: 'aggregate-fields',
    content: '<path stroke-linecap="round" stroke-linejoin="round" d="M5.25 6h13.5m-12-3h10.5M4.5 9h15a.75.75 0 0 1 .75.75v9a.75.75 0 0 1-.75.75h-15a.75.75 0 0 1-.75-.75v-9A.75.75 0 0 1 4.5 9" fill="none"/>',
    viewBox: '0 0 24 24',
    variants: {
        ...
        'outline': '<path stroke-linecap="round" stroke-linejoin="round" d="M5.25 6h13.5m-12-3h10.5M4.5 9h15a.75.75 0 0 1 .75.75v9a.75.75 0 0 1-.75.75h-15a.75.75 0 0 1-.75-.75v-9A.75.75 0 0 1 4.5 9" fill="none"/>',
        'duotone': '<path fill-opacity="0.2" d="M19.5 9h-15a.75.75 0 0 0-.75.75v9a.75.75 0 0 0 .75.75h15a.75.75 0 0 0 .75-.75v-9A.75.75 0 0 0 19.5 9"/><path stroke-linecap="round" stroke-linejoin="round" d="M5.25 6h13.5m-12-3h10.5M4.5 9h15a.75.75 0 0 1 .75.75v9a.75.75 0 0 1-.75.75h-15a.75.75 0 0 1-.75-.75v-9A.75.75 0 0 1 4.5 9" fill="none"/>'
    },
