...
export const linePointRoundedIcon: SVGIcon = {
    name: 'line-point-rounded',
    content: '<path stroke-linecap="round" stroke-linejoin="round" d="M20.2496 9.7501C18.985 9.7506 7.2431 9.75 6.0005 9.75s-2.25 1.0074-2.25 2.25 1.0074 2.25 2.25 2.25h14.2491" fill="none" stroke-width="var(--kendo-icon-stroke-width, 1.5)"/>',
    viewBox: '0 0 24 24',
    variants: {
