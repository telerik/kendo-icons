...
export const caretAltRightIcon: SVGIcon = {
    name: 'caret-alt-right',
    content: '<path stroke-linecap="round" stroke-linejoin="round" d="m9 4.5 7.5 7.5L9 19.5" fill="none" stroke-width="var(--kendo-icon-stroke-width, 1.5)"/>',
    viewBox: '0 0 24 24',
    variants: {
    ...
    tags: ['caret', 'alt', 'right', 'navigation', 'arrow', 'dropdown', 'expand']
}
