...
export const radiobuttonIcon: SVGIcon = {
    name: 'radiobutton',
    ...
    viewBox: '0 0 24 24',
    variants: {
        'solid': '<path d="M11.9994 21.7501c5.3848 0 9.75-4.3652 9.75-9.7499s-4.3652-9.75-9.75-9.75c-5.3847 0-9.7499 4.3652-9.7499 9.75 0 5.3847 4.3652 9.7499 9.7499 9.7499"/>',
