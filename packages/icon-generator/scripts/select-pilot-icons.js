#!/usr/bin/env node
/* eslint-disable no-console, camelcase, no-nested-ternary */

/**
 * Pilot Batch Icon Selection
 *
 * Selects 30 high-priority icons for the pilot batch based on usage patterns and complexity.
 */
...
allIcons.forEach(icon => {
    ...
    for (const [ , data ] of Object.entries(priorities)) {
